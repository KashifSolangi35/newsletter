...
<section class="showcase">
  <div class="container">
    <div class="pb-2 mt-4 mb-2 border-bottom">
      <h2>Build a Newsletter Email Subscription with PHP and MySQL</h2>
    </div>
    <div class="row">
    ...
    <div class="row align-items-center">
      <div class="col-sm-6 offset-md-3">
        <div>
              <h2 style="text-align: center;" class="text-muted">SUBSCRIBE NOW</h2>
            </div>
       <div class="form-group">
          <div class="col-sm-12">          
            <input type="text" class="form-control newsletter-name" id="newsletter-name" placeholder="Name*" name="name">
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-12">          
            <input type="text" class="form-control newsletter-email" id="newsletter-email" placeholder="Email*" name="email" >
          </div>
        </div> 
        <div class="form-group">        
          <div class="col-sm-offset-2 col-sm-12">
            <button type="button" class="btn btn-info float-right" id="subscribe-newsletter">Subscribe</button>
          </div>
        </div>
    </div>
  </div>
